...
(cl:defmethod cl:initialize-instance :after ((m <WheelMotor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WheelMotor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name remote_control-msg:<WheelMotor> is deprecated: use remote_control-msg:WheelMotor instead.")))
