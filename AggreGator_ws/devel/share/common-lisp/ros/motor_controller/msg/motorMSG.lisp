...
(cl:defmethod cl:initialize-instance :after ((m <motorMSG>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'motorMSG)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name motor_controller-msg:<motorMSG> is deprecated: use motor_controller-msg:motorMSG instead.")))
