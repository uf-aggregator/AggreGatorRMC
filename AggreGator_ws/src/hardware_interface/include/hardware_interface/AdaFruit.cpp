...
void AdaFruit::setWheelMotorI2C(const motor_controller::AdaCmd& msg)
{  
...
void AdaFruit::setBucketMotorI2C(const motor_controller::AdaCmd& msg)
{
...
void AdaFruit::setLinearActuatorI2C(const motor_controller::AdaCmd& msg)
{	
    PWM_setting pwm = AdaFruit::convertSetpointToPWM(msg.value[0]);
...
//Callback function
void AdaFruit::adaFruitCallBack(const motor_controller::AdaCmd& msg)
{
